...
-- This table allows you to save your API keys and configuratiON "Parser".directly in the database,
...
-- INSERT INTO "Parser".client_configs (retail_divisor, min_price_divisor) VALUES (0.3, 0.45);

-- Security Recommendation: Enable Row Level Security (RLS)
-- ALTER TABLE "Parser".client_configs ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "Allow all for internal dashboard" ON "Parser".client_configs FOR ALL USING (true);
