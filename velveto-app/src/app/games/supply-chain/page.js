            ...
            <main style={{ maxWidth: '1200px', margin: '0 auto' }}>
                {gameState === 'start' && (
                    <div style={{ textAlign: 'center', padding: '5rem 0' }}>
                        ...
                        <p style={{ color: '#8a90a4', maxWidth: '700px', margin: '0 auto 3rem auto', fontSize: '1.2rem', lineHeight: '1.8' }}>
                            30 дней выживания. У тебя ограниченный капитал, платный склад (5₽/ед) и непредсказуемый рынок.
                            Задержки на таможне и хайп в соцсетях изменят твои планы. Считай каждую единицу.
                        </p>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: '3rem' }}>
                        <div>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.5rem', marginBottom: '2rem' }}>
                                <StatCard label="КАПИТАЛ" value={`${Math.floor(capital).toLocaleString()} ₽`} color={capital < 0 ? '#ef4444' : '#10b981'} />
