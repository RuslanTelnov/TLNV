        ...
        <div style={{ minHeight: '100vh', background: 'var(--velveto-bg-primary)', color: 'var(--velveto-text-primary)', padding: '2rem' }}>
            <header style={{ marginBottom: '3rem', textAlign: 'center' }}>
                <h1 style={{ fontSize: '3rem', fontWeight: '200', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                    Логистический <span style={{ color: 'var(--velveto-accent-primary)' }}>Дашборд</span>
                </h1>
            ...
            <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                {/* Search and Filters */}
                <div style={{ display: 'flex', gap: '2rem', marginBottom: '2rem', background: 'var(--velveto-bg-secondary)', padding: '1.5rem', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)' }}>
                    <div style={{ flex: 1 }}>
                ...
                {loading ? (
                    ...
                    <div style={{ overflowX: 'auto', background: 'var(--velveto-bg-secondary)', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.05)', boxShadow: '0 20px 40px rgba(0,0,0,0.3)' }}>
